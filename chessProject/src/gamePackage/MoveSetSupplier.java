 ...
 * @author PKamps
 */
abstract class MoveSetSupplier {
   ...
   * @return pawnMoveSet
   */
  static ArrayList<ArrayList<Integer>> supplyPawnMoveSet() {
   ...
   * @return kingMoveSet
   */
  static ArrayList<ArrayList<Integer>> supplyKingMoveSet() {
    ArrayList<Integer> entry1 = new ArrayList<Integer>(Arrays.asList(0, 1));
   ...
   * @return rookMoveSet
   */
  static ArrayList<ArrayList<Integer>> supplyRookMoveSet() {
    ArrayList<Integer> entry1 = new ArrayList<Integer>(Arrays.asList(0, 1));
   ...
   */
  static ArrayList<ArrayList<Integer>> supplyKnightMoveSet() {
   ...
   */
  static ArrayList<ArrayList<Integer>> supplyBishopMoveSet() {
   ...
   * @return queenMoveSet
   */
  static ArrayList<ArrayList<Integer>> supplyQueenMoveSet() {
